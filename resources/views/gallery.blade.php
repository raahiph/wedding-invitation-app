...
<meta property="og:description" content="Browse wedding photos shared by guests — {{ $wedding['date'] }}, {{ $wedding['city'] }}.">
...
function uploadFile(file) {
  ...
  const statusEl = li.querySelector('#qs-status');
  const fillEl   = li.querySelector('#qs-fill');

  // Remove id attrs (they're only for scoping above)
  statusEl.removeAttribute('id');
